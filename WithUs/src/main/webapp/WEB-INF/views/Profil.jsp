...
<body>
	...
	<div id="contain">
		...
		<div class="container m-auto mt-4 p-5 p-md-1 ">
			...
			<div class="menubar mb-5">
				<div>
					<span class="menubar__Profile fontjordyblue">Profile</span>
				</div>
				<div class="progress" style="height: 2px;">
					<div class="progress-bar backjordyblue" role="progressbar"
						style="width: 120px" aria-valuenow="50" aria-valuemin="0"
						aria-valuemax="100"></div>
				</div>
			</div>
			<div
				class="profile--container row shadow-sm p-5 p-md-2 mb-5 bg-body rounded flex-md-row align-items-md-center">
				<div class="profile row align-items-end col-md-6">
					<div
						class="avatar  col-4 col-md-3 rounded-circle align-self-center">
						<img src="resources/pro_img/<%=memPro.getMb_proimg()%>">
					</div>
					<div class="name col-8">
						<h2 class="mb-0 fs-2"><%=memPro.getMb_nick()%></h2>
						<br>
						<button type="button" class="btn text-white btn-danger"
							data-bs-target="#reportModal">신고</button>
						<button type="button" id="followbtn"
							class="btn text-white btn-primary"
							onclick="toggleFollow('<%=loginMember.getMb_id()%>','<%=memPro.getMb_id()%>')">팔로우</button>
							...
							<div class="modal-body">
								<form id="reportForm">
									...
									<input type="hidden" id="reporter"
										...
										id="reportee" value="<%=memPro.getMb_id()%>" />
									<!-- 대상 사용자 ID를 여기에 입력 -->
									<button type="button" class="btn btn-danger d_btn"
				...
				<div
					class="information row mt-5 mt-md-3 pt-4 pt-md-0 mb-2 col-md-4 vr-4 border-md-start">
   ...
   $(document).ready(function() {
    ...
    function getFollowData() {
		...
		// 모달 초기화
		var reportModal = new bootstrap.Modal(document
