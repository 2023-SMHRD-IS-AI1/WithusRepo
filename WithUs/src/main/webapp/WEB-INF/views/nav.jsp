...
<body>
	...
	<header>
		...
		<ul id="r_nav">
			...
			<li><a href="${pageContext.request.contextPath}/goUserinfo"><i
					class="fa fa-cog" aria-hidden="true"></i></a></li>
			<li><a href="${pageContext.request.contextPath}/goDaily"><i
					class="fa-solid fa-calendar"></i></a></li>
	...
	<!-- 프로필 Modal -->
	<div class="modal fade" id="mypmodal" data-bs-backdrop="static"
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="all">
							...
							<div id="p_con">
								<p>
									팔로우 : <span id="followerCount"></span> &nbsp;&nbsp; 팔로잉 : <span
										id="followingCount"></span>
								</p>
								<br>
								<p>
									닉네임 : <span><%=loginMember.getMb_nick()%></span>
								</p>
								<br>
								<p>
									생년월일 : <span><%=loginMember.getMb_birthdate()%></span>
								</p>
								<br>
								<p>
									MBTI : <span><%=loginMember.getMb_mbti()%></span>
								</p>
