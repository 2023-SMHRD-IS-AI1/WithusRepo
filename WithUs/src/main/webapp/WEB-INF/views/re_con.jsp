			...
			<div class="modal-content">
				...
				<div class="modal-body" id="p_bodays">
					...
					<form id="updateReviewForm"
						action="${pageContext.request.contextPath}/updateReview"
						method="post">
						<input type="hidden" name="review_idx"
							value="${review.getReview_idx()}" />
						<div class="mb-3">
							<label for="updatedTitle" class="form-label">제목</label> <input
								type="text" class="form-control" id="updatedTitle"
								name="review_title" value="${review.getReview_title()}" required />
						</div>
						<div class="mb-3">
							<label for="updatedContent" class="form-label">내용</label>
							<textarea class="form-control" id="updatedContent"
								name="review_content" rows="5" required>${review.getReview_content()}</textarea>
						</div>
						<div class="mb-3">
							<label for="updatedRegion" class="form-label">지역</label>
							<textarea class="form-control" id="updatedRegion"
								name="review_region" rows="5" required>${review.getReview_region()}</textarea>
						</div>
						<div id="f_btn2">
							<button type="button" class="btn btn-primary"
								onclick="submitUpdateReview()">수정 완료</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer" id="del_fot">
					<form action="${pageContext.request.contextPath}/deleteReview"
	...
	<div id="contain">
		<div id="revBox">
			...
			<div id="revContent">
				...
				<div id="revTxt">${review.review_content}</div>
				<div id="travelInfo">
				...
				<li>
					...
					<div class="commentDate">
						...
						<button class="updateCommentBtn" data-bs-toggle="modal"
							...
							onclick="showUpdateCommentForm(<%=comment.getCmt_idx()%>)">수정</button>
						<form action="${pageContext.request.contextPath}/deleteComment"
							method="post">
							<input type="hidden" name="cmt_idx"
								value="<%=comment.getCmt_idx()%>" /> <input type="hidden"
								name="review_idx" value="${review.getReview_idx()}" />
				...
				<div class="modal-body">
					...
					<form id="updateCommentForm"
						...
						<input type="hidden" id="cmt_idx_input" name="cmt_idx" /> <input
							type="hidden" name="review_idx" value="${review.getReview_idx()}" />
						<div class="mb-3">
