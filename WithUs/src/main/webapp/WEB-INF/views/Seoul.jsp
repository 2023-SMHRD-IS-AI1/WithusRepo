...
<div id="contain">
   ...
   <script>
      ...
      var mapContainer = document.getElementById("map"),
          mapOption = {
              center: new kakao.maps.LatLng(37.5570994, 127.0116712),
              level: 7, // 지도의 확대 레벨
          };
      ...
      function Gr() {
          ...
          var mapContainer = document.getElementById("map"),
              mapOption = {
                  center: new kakao.maps.LatLng(37.7564341, 128.8948752),
                  level: 8,
              };
      ...
      function jj() {
          ...
          var mapContainer = document.getElementById("map"),
              mapOption = {
                  center: new kakao.maps.LatLng(33.4867686, 126.489452),
                  level: 7,
              };
      ...
      function bs() {
          ...
          var mapContainer = document.getElementById("map"),
              mapOption = {
                  center: new kakao.maps.LatLng(35.1580808, 129.058029),
                  level: 8, // 지도의 확대 레벨
              };
