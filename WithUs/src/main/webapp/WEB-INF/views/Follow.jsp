              ...
              <div class="tab-content profile-tab" id="myTabContent">
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                      ...
                      <ul id ="nav1" class="nav nav-pills mb-3" id="myTab" role="tablist">
                          <li class="nav-item">
                              <a class="nav-link active" id="home-tab" data-toggle="tab" href="goFollow" role="tab" aria-controls="home" aria-selected="true">팔로우</a>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link " id="profile-tab" data-toggle="tab" href="goProfil" role="tab" aria-controls="profile" aria-selected="false">팔로잉 </a>
                          </li>
                      </ul>
                  <div class="container">
